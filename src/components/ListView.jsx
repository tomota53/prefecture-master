...
import PrimeMinisterCard from './PrefectureCard';
import FilterBar from './FilterBar';
import useLocalStorage from '../hooks/useLocalStorage';
import allPrimeMinistersData from '../data/allprefectures.json';

const ListView = ({ prefecturesData }) => {
  // データモード選択
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="text-sm text-gray-600 mb-1">頻出都道府県の進捗</div>
            <div className="flex items-end gap-2 mb-2">
              <span className="text-3xl font-bold text-red-600">
                {statistics.highLearned}
              </span>
              <span className="text-lg text-gray-600 mb-1">
                / {statistics.highFrequency}都道府県
              </span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
        ...
        <div className="mb-4">
          <div className="text-sm text-gray-600">
            {filteredAndSortedData.length}件の都道府県が見つかりました
            {searchQuery && (
